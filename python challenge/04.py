...
#new_data = data
#new_data = 'abCDEfGEHdsahfekwnfdgsfakGHJfnejwlandOIUbfjekadfHJKeTYU'

i = 0

while i < len(new_data)-8:
    if new_data[i].islower():
        if new_data[i+1:i+4].isupper():
            if new_data[i+5:i+8].isupper():
                if new_data[i+4].islower():
                    if new_data[i+8].islower():
                        print(new_data[i + 4], end='')
                    else:
                        pass
                else:
                    pass
